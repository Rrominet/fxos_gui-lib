...
namespace ml
{
    ...
    class App    
    {
        public : 
            ...
            void executeBackendCommand(Process* p, const std::string &function, const json& args={}, const std::function<void(const json& response)>& cb=0);
            void executeBackendCommand(Process* p, const std::string& name, const std::string& id, const std::string &function, const json& args={}, const std::function<void(const json& response)>& cb=0);
